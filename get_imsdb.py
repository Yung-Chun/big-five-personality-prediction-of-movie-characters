...
SCRIPT_INFO_URL = "http://www.imsdb.com/scripts/"
...
parser.add_argument("path",
                    help="path of directory where the data will be saved")
parser.add_argument(
    "format",
    help=
    "True or False, if True the scripts will be formatted for machine readability"
)
